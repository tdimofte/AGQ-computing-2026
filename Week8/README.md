### Lecture 8: Scientific computing with Julia ###
...
I highly recommend installing the relevant libraries before attending the Workshop section of this lecture. Download the Manifest.toml and Project.toml files. Open Julia in the terminal and run 
